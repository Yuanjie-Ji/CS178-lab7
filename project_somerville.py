...
def project_somerville():
	...
	pca_results = PCA(n_components=2).fit_transform(raw_data)
	mds_results = MDS(n_components=2, normalized_stress='auto').fit_transform(raw_data)
	# tsne_results = TSNE(n_components=2, learning_rate='auto', init='random', perplexity=2).fit_transform(raw_data)
	tsne_results = TSNE(n_components=2, learning_rate='auto', init='random', perplexity=5).fit_transform(raw_data)
	# tsne_results = TSNE(n_components=2, learning_rate='auto', init='random', perplexity=10).fit_transform(raw_data)
	# tsne_results = TSNE(n_components=2, learning_rate='auto', init='random', perplexity=20).fit_transform(raw_data)
